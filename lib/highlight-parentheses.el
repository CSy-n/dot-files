...
(defcustom hl-paren-colors
  ;; '("firebrick1" "IndianRed1" "IndianRed3" "Red")
  ;; '("Red3" "magenta" "violet" "DarkViolet" "DarkMagenta")
  ;; '("Red3" "magenta" "violet")
  ;; '("#d33682" "#e1af4b" "#2aa198")
  ;; (list-colors-display  '("#a7020a" "#d33682" "#6ccec0"))
  ;; (list-colors-display  '("#b58900" "#6c71c4" "#a7020a"))
  '("#b58900" "#6c71c4" "#a7020a")
...
(defcustom hl-paren-highlight-adjacent t
