;;; mex.el --- track command frequencies
;; -*- coding: utf-8 -*-
;;
...
;; Version 1.8
;;
;; Origin: https://github.com/dacap/keyfreq
;; Package-Requires: ((cl-lib "0.5"))
;;
;;
;; KeyBinding Metrics is free software; you can redistribute it and/or modify it
;; under the terms of the GNU General Public License as published by
;; the Free Software Foundation; either version 3 of the License, or
;; (at your option) any later version.
;;
;;
;; Keywords: metrics, keys, extensions
;;
;; Change Log:
;; Version 1.8 - 2019-6 - CSy-n
;; * Renamed keyfreq.el to keybinding-metrics.el
;;
